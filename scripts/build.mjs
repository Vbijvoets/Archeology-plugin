...
if (!appSource.includes('.sort(compareCollections)') || !appSource.includes("replace(/^Museum - /i,''")) throw new Error('Similar collection names must be grouped and ordered');
